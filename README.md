# Users Dashboard (Панель управления пользователями)

Современная панель управления пользователями, построенная с использованием React, TypeScript и CSS modules.
...
- 🔗 Сохранение состояния в URL параметрах (React Router)
- 🎨 Чистый и современный интерфейс с использованием CSS Modules
...
- **CSS Modules** - Безопасные стили
- **React Router DOM** - Маршрутизация и управление URL параметрами
- **Axios** - HTTP клиент
...
└── URL_PARAMETERS_IMPLEMENTATION.md  # Документация по реализации URL параметров
```
...
- **React Router URL параметры** - Хранение состояния приложения в URL
- **Параметры пагинации** - `?page=` (текущая страница) и `?pageSize=` (размер страницы)
- **Параметр поиска** - `?search=` (поисковый запрос)
- **Возможности**:
  - Закладки для конкретных представлений данных
  - Совместное использование URL с сохраненным состоянием
  - Использование кнопок "Назад"/"Вперед" браузера для навигации
  - Обновление страницы без потери текущего состояния
- **Примеры URL**:
  - По умолчанию: `http://localhost:3000/`
  - Страница 3 с 20 элементами: `http://localhost:3001/?page=3&pageSize=20`
  - Поиск "john": `http://localhost:3001/?search=john&page=1&pageSize=10`
  - Комбинированный: `http://localhost:3001/?search=smith&page=2&pageSize=30`
